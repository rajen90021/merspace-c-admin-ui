...
const Products = () => {
    ...
    const onHandleSubmit = async () => {
        ...
        const pricing = Object.entries(priceConfiguration).reduce((acc, [key, value]) => {
            ...
            // Fix typo: frontend "additional" → backend "aditional"
            const correctedPriceType =
                parsedKey.priceType === 'additional' ? 'aditional' : parsedKey.priceType;

            return {
                ...acc,
                [parsedKey.configurationKey]: {
                    priceType: correctedPriceType,
